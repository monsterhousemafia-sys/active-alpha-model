"""Build codex_v4r_gui_safety_review.zip with duplicate-path and hash guards."""
...
ZIP_NAME = "codex_v4r_gui_safety_review.zip"

INCLUDE = [
    "EXTERNAL_REVIEW_APPROVAL_V4R.md",
    "AGENTS.md",
    "VISION_PROGRESS.json",
    doc_rel("CODEX_V4R_PREFLIGHT.md"),
    doc_rel("CODEX_V4R_GIT_STATUS.txt"),
    doc_rel("CODEX_V4R_GUI_SAFETY_REPORT.md"),
    doc_rel("CODEX_V4R_TEST_OUTPUT.txt"),
    doc_rel("CODEX_V4R_PROTECTED_HASHES_BEFORE.json"),
    doc_rel("CODEX_V4R_PROTECTED_HASHES_AFTER.json"),
    ...
    "tools/complete_v4_run.py",
    "tools/build_v4_review_zip.py",
    "tools/complete_v4r_run.py",
    "tools/build_v4r_review_zip.py",
...
def validate_protected_hashes(root: Path) -> Tuple[bool, List[str]]:
    errors: List[str] = []
    before_path = root / doc_rel("CODEX_V4R_PROTECTED_HASHES_BEFORE.json")
    after_path = root / doc_rel("CODEX_V4R_PROTECTED_HASHES_AFTER.json")
