#!/usr/bin/env python3
"""G0R4R verbatim external review chain resubmission orchestrator."""
...
from aa_decision_cockpit_readonly_snapshot import write_g0r4r_review_snapshot
from aa_doc_paths import doc_path
from aa_evidence_schema import AUTHORITATIVE_CHAMPION
from aa_safe_io import atomic_write_json

ROOT = _REPO_ROOT
G0R4R_PHASE_ID = "G0R4R_VERBATIM_EXTERNAL_REVIEW_CHAIN_RESUBMISSION"
G0R4R_ZIP = ROOT / "codex_g0r4r_verbatim_external_review_chain_resubmission.zip"
G0R4R_SHA = doc_path("codex_g0r4r_verbatim_external_review_chain_resubmission.zip.sha256")
G0R4R_ATTESTATION = ROOT / "codex_g0r4r_detached_submission_attestation.json"
G0R4R_VERIFY_REPORT = ROOT / "codex_g0r4r_detached_package_verification_report.md"
INPUT_DIR_REL = "incoming_external_reviews/g0r4r"
INPUT_DIR = ROOT / INPUT_DIR_REL
VERBATIM_INPUTS_ZIP = INPUT_DIR / "G0R4R_VERBATIM_EXTERNAL_REVIEW_INPUTS.zip"
APPROVAL_DOC_NAME = "EXTERNAL_REVIEW_APPROVAL_G0R4R_REMEDIATION_RESUBMISSION_ONLY.md"
...
EXPECTED_APPROVAL_SHA256 = "498cc262f6dac2696fd9d93b4ba158ddee78791069d9f2a2a72c571407242ec6"
EXPECTED_BUNDLE_SHA256 = "e38526ce71ef4cd8c893e59420d7b3918ded5166ba7d2aee6ade7d28bdd1fc35"
BUNDLE_ZIP_NAME = "G0R4R_CODEX_INPUT_BUNDLE.zip"
BUNDLE_SIDECAR_NAME = f"{BUNDLE_ZIP_NAME}.sha256"
BUNDLE_MANIFEST_NAME = "G0R4R_CODEX_INPUT_MANIFEST.json"
...
EXPECTED_INDIVIDUAL_INPUT_HASHES: Dict[str, str] = {
    ...
    APPROVAL_SIDECAR_NAME: "37a370112a8d65a1052254372e0b4fa838a8a51793ef3aaa4b867eb8dcc1feee",
    "EXTERNAL_REVIEW_DECISION_G0R4_REMEDIATION_REQUIRED.md": (
        "0839fcf93d63d89091cef9c8f68cf737c56443c74d23edec1f88e9eba90de719"
    ),
    "EXTERNAL_REVIEW_OBSERVED_HASH_G0R4.sha256": (
        "4d8795453a1789ce6a552641a240e88430de2e796ffdc435e0155265f3c2bee9"
    ),
    "G0R4R_VERBATIM_EXTERNAL_REVIEW_INPUTS.zip": (
        "1d60660b5710476db0c5bb708a15d0e20f0a8c3e67b5c4f8707b343214335e22"
    ),
}
OPERATIVE_FORBIDDEN_APPROVAL_MARKERS: Tuple[str, ...] = (
    "G1_AUTHORIZED = YES",
    "G1_AUTHORIZED=YES",
    "G1 EXECUTION",
    "TURNOVER",
...
PAYLOAD_MANIFEST_NAME = "CODEX_G0R4R_COMMITTED_PAYLOAD_MANIFEST.json"
G0R4R_COMMIT_MSG = "fix: resubmit G0R4R with verbatim external review chain"

VERBATIM_EXTERNAL_MAPPINGS: Tuple[Tuple[str, str], ...] = (
    (
        "EXTERNAL_REVIEW_DECISION_G0_REMEDIATION_REQUIRED.md",
        "control/external_reviews/g0_g1_rejection/EXTERNAL_REVIEW_DECISION_G0_REMEDIATION_REQUIRED.md",
    ),
    (
        "EXTERNAL_REVIEW_DECISION_G1_NOT_APPROVED.md",
        "control/external_reviews/g0_g1_rejection/EXTERNAL_REVIEW_DECISION_G1_NOT_APPROVED.md",
    ),
    (
        "EXTERNAL_REVIEW_SUMMARY_G0_G1.md",
        "control/external_reviews/g0_g1_rejection/EXTERNAL_REVIEW_SUMMARY_G0_G1.md",
    ),
    (
        "EXTERNAL_REVIEW_DECISION_G0R_REMEDIATION_REQUIRED.md",
        "control/external_reviews/g0r_rejection/EXTERNAL_REVIEW_DECISION_G0R_REMEDIATION_REQUIRED.md",
    ),
    (
        "EXTERNAL_REVIEW_DECISION_G0R2_REMEDIATION_REQUIRED.md",
        "control/external_reviews/g0r2_rejection/EXTERNAL_REVIEW_DECISION_G0R2_REMEDIATION_REQUIRED.md",
    ),
    (
        "EXTERNAL_REVIEW_DECISION_G0R3_REMEDIATION_REQUIRED.md",
...
# Six historical review inputs must come from the verbatim zip when present.
VERBATIM_ZIP_ONLY_SOURCES: Set[str] = {
    "EXTERNAL_REVIEW_DECISION_G0_REMEDIATION_REQUIRED.md",
    "EXTERNAL_REVIEW_DECISION_G1_NOT_APPROVED.md",
    "EXTERNAL_REVIEW_SUMMARY_G0_G1.md",
    "EXTERNAL_REVIEW_DECISION_G0R_REMEDIATION_REQUIRED.md",
...
PREEXISTING_PHASE_ARTIFACT_EXCLUSIONS: Tuple[str, ...] = (
    ...
    "incoming_external_reviews/g0r4r/G0R4R_CODEX_INPUT_BUNDLE.zip",
    "incoming_external_reviews/g0r4r/G0R4R_CODEX_INPUT_BUNDLE.zip.sha256",
    "incoming_external_reviews/g0r4r/G0R4R_CODEX_INPUT_MANIFEST.json",
    "incoming_external_reviews/g0r4r/G0R4R_VERBATIM_EXTERNAL_REVIEW_INPUTS.zip",
    "incoming_external_reviews/g0r4r/EXTERNAL_REVIEW_APPROVAL_G0R4R_REMEDIATION_RESUBMISSION_ONLY.md",
    "incoming_external_reviews/g0r4r/EXTERNAL_REVIEW_APPROVAL_G0R4R_REMEDIATION_RESUBMISSION_ONLY.md.sha256",
    "incoming_external_reviews/g0r4r/EXTERNAL_REVIEW_DECISION_G0R4_REMEDIATION_REQUIRED.md",
    "incoming_external_reviews/g0r4r/EXTERNAL_REVIEW_OBSERVED_HASH_G0R4.sha256",
)
...
AUTHORIZED_G0R4R_COMMIT_PATHS: Tuple[str, ...] = (
    ".gitattributes",
    "docs/phases/G0R4R/CODEX_G0R4R_PREFLIGHT.md",
    "docs/phases/G0R4R/CODEX_G0R4R_EXTERNAL_REJECTION_REMEDIATION_REPORT.md",
    "docs/integrity/session_logs/G0R4R/CODEX_G0R4R_GIT_STATUS.txt",
    "docs/phases/G0R4R/CODEX_G0R4R_COMMITTED_PAYLOAD_MANIFEST.json",
    "docs/phases/G0R4R/CODEX_G0R4R_INPUT_DISCOVERY_REPORT.md",
    "docs/phases/G0R4R/CODEX_G0R4R_EXTERNAL_INPUT_HASH_VERIFICATION.json",
    "docs/phases/G0R4R/CODEX_G0R4R_AUTHORIZATION_VERIFICATION.json",
    "docs/phases/G0R4R/CODEX_G0R4R_EXTERNAL_REVIEW_INPUT_VERBATIM_VERIFICATION.json",
    "docs/phases/G0R4R/CODEX_G0R4R_V5R_BASELINE_COMPARISON.json",
    "docs/integrity/protected_hashes/G0R4R/CODEX_G0R4R_PROTECTED_HASHES_BEFORE.json",
    "docs/integrity/protected_hashes/G0R4R/CODEX_G0R4R_PROTECTED_HASHES_AFTER.json",
    "docs/integrity/session_logs/G0R4R/CODEX_G0R4R_TEST_OUTPUT.txt",
    "G0R4R-CHANGE_MANIFEST.json",
    "control/review_snapshot/g0r4r_decision_cockpit_snapshot.json",
    ...
    "EXTERNAL_REVIEW_APPROVAL_G0R4R_TEMPLATE.md",
    "tools/complete_g0r4r_submission.py",
    "tests/test_g0r4r_submission_integrity.py",
...
def _verify_sidecar(sidecar_path: Path, target_name: str) -> Tuple[bool, str]:
    if not sidecar_path.is_file():
        return False, ""
    line = sidecar_path.read_text(encoding="utf-8").strip().split()[0]
    return line == _sha256_file(INPUT_DIR / target_name), line
...
def write_input_discovery_report(*, discovery: Dict[str, Any], branch: str, head: str) -> None:
    lines = [
        "# CODEX G0R4R Input Discovery Report",
        "",
    ...
    for name in REQUIRED_INPUT_FILES:
        ...
        if actual:
            lines.append(f"  - actual path: `{actual}`")
    lines.extend(
        [
            "",
            f"Required files found: {discovery.get('found_file_count')}/{discovery.get('required_file_count')}",
            f"Immutable external source treatment: {discovery.get('input_directory_treated_as_immutable_external_source')}",
        ]
    )
    _write_text(doc_path("CODEX_G0R4R_INPUT_DISCOVERY_REPORT.md"), "\n".join(lines) + "\n")
...
def verify_input_bundle() -> Tuple[bool, Dict[str, Any]]:
    ...
    manifest_path = INPUT_DIR / BUNDLE_MANIFEST_NAME
    actual_bundle_hash = _sha256_file(bundle_path) if bundle_path.is_file() else ""
    sidecar_ok, sidecar_hash = _verify_sidecar(sidecar_path, BUNDLE_ZIP_NAME)
    ...
    for name, expected in EXPECTED_INDIVIDUAL_INPUT_HASHES.items():
        path = INPUT_DIR / name
        actual = _sha256_file(path) if path.is_file() else ""
        manifest_expected = manifest_hashes.get(name, expected)
        match = actual == expected and actual == manifest_expected
        if not match:
            all_inputs_ok = False
        individual.append(
            {
                "path": f"{INPUT_DIR_REL}/{name}",
    ...
    manifest_ok = (
        manifest_loaded
        and manifest.get("authorized_phase_only") == G0R4R_PHASE_ID
...
def verify_external_remediation_approval() -> Tuple[bool, Dict[str, Any]]:
    ...
    sidecar_ok, _ = _verify_sidecar(sidecar_path, APPROVAL_DOC_NAME)
    body = approval_path.read_text(encoding="utf-8") if approval_path.is_file() else ""
    authorized_phase_found = G0R4R_PHASE_ID in body
    g1_authorized = bool(
...
def load_verbatim_original_bytes() -> Tuple[bool, Dict[str, bytes], str]:
    originals: Dict[str, bytes] = {}
    if VERBATIM_INPUTS_ZIP.is_file():
        with zipfile.ZipFile(VERBATIM_INPUTS_ZIP) as zf:
            zip_names = {_norm(Path(n).name): n for n in zf.namelist()}
            for source_name in VERBATIM_ZIP_ONLY_SOURCES:
                key = _norm(source_name)
                if key not in zip_names:
                    return False, {}, f"missing in verbatim zip: {source_name}"
                originals[source_name] = zf.read(zip_names[key])
            for source_name, _target in VERBATIM_EXTERNAL_MAPPINGS:
                if source_name in originals:
                    continue
                key = _norm(source_name)
                if key in zip_names:
                    originals[source_name] = zf.read(zip_names[key])
    elif VERBATIM_ZIP_ONLY_SOURCES:
        return False, {}, f"missing verbatim zip: {VERBATIM_INPUTS_ZIP.name}"

    for source_name, _target in VERBATIM_EXTERNAL_MAPPINGS:
        if source_name in originals:
            continue
        root_path = INPUT_DIR / source_name
        if root_path.is_file():
            originals[source_name] = root_path.read_bytes()
            continue
        return False, {}, f"verbatim input missing: {INPUT_DIR_REL}/{source_name}"
    return True, originals, ""


def apply_verbatim_external_review_inputs() -> Tuple[bool, str]:
    ok, originals, msg = load_verbatim_original_bytes()
    if not ok:
        return False, msg
    for source_name, target_rel in VERBATIM_EXTERNAL_MAPPINGS:
        target = ROOT / target_rel
        target.parent.mkdir(parents=True, exist_ok=True)
        target.write_bytes(originals[source_name])
    return True, ""


def verify_verbatim_external_review_inputs(
        ...
        entries.append(
            {
                ...
                "external_original_filename": source_name,
                "external_original_sha256": original_hash,
                "repository_target_sha256": target_hash,
                "included_zip_entry_sha256": zip_entry_hash,
                "byte_identical_source_to_target": source_to_target,
                "byte_identical_target_to_zip": target_to_zip,
            }
        )
    return all_ok, {
        "phase": G0R4R_PHASE_ID,
...
def build_zip_include_list() -> List[str]:
    ...
    docs = [
        doc_path("CODEX_G0R4R_PREFLIGHT.md").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_EXTERNAL_REJECTION_REMEDIATION_REPORT.md").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_GIT_STATUS.txt").relative_to(ROOT).as_posix(),
        manifest_rel,
        doc_path("CODEX_G0R4R_V5R_BASELINE_COMPARISON.json").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_PROTECTED_HASHES_BEFORE.json").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_PROTECTED_HASHES_AFTER.json").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_INPUT_DISCOVERY_REPORT.md").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_EXTERNAL_INPUT_HASH_VERIFICATION.json").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_AUTHORIZATION_VERIFICATION.json").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_EXTERNAL_REVIEW_INPUT_VERBATIM_VERIFICATION.json").relative_to(ROOT).as_posix(),
        doc_path("CODEX_G0R4R_TEST_OUTPUT.txt").relative_to(ROOT).as_posix(),
        "G0R4R-CHANGE_MANIFEST.json",
    ]
    snapshots = [
...
def build_exact_byte_zip(commit: str, include: List[str]) -> Tuple[str, List[str], Dict[str, bytes]]:
    if G0R4R_ZIP.is_file():
        G0R4R_ZIP.unlink()
    missing: List[str] = []
    zip_bytes: Dict[str, bytes] = {}
    with zipfile.ZipFile(G0R4R_ZIP, "w", compression=zipfile.ZIP_DEFLATED) as zf:
        for rel in include:
            norm = _norm(rel)
            ...
            zip_bytes[norm] = blob
    return _sha256_file(G0R4R_ZIP), missing, zip_bytes
    ...
    *,
    ...
    for entry in manifest.get("payload_entries") or []:
        ...
        if actual_zip != expected or actual_commit != expected or actual_zip != actual_commit:
            ...
            verified += 1
    sidecar_ok = False
    if G0R4R_SHA.is_file():
        sidecar_ok = G0R4R_SHA.read_text(encoding="utf-8").strip().split()[0] == zip_digest
...
def write_detached_attestation(
    *,
    ...
    payload = {
        ...
        "zip_file": G0R4R_ZIP.name,
        "zip_sha256": zip_digest,
        "sidecar_file": G0R4R_SHA.name,
    ...
    atomic_write_json(G0R4R_ATTESTATION, payload)
...
def update_phase_catalog() -> None:
    ...
    if not any(p.get("phase_id") == G0R4R_PHASE_ID for p in phases):
        phases.append(
            {
                "phase_id": G0R4R_PHASE_ID,
                "phase_key": "G0R4R",
...
def update_review_registry() -> None:
    ...
    if not any(r.get("phase_id") == G0R4R_PHASE_ID for r in reviews):
        reviews.append(
            {
                "phase_id": G0R4R_PHASE_ID,
                "phase_key": "G0R4R",
...
def write_change_manifest(modified: List[str]) -> None:
    atomic_write_json(
        ROOT / "G0R4R-CHANGE_MANIFEST.json",
        {
            "schema_version": 1,
            "phase": G0R4R_PHASE_ID,
...
def write_git_status(*, branch: str, start_head: str) -> None:
    _write_text(
        doc_path("CODEX_G0R4R_GIT_STATUS.txt"),
        "\n".join(
            [
                f"branch={branch}",
...
def write_preflight(start_head: str, branch: str) -> None:
    _write_text(
        doc_path("CODEX_G0R4R_PREFLIGHT.md"),
        "\n".join(
            [
...
def write_report(*, test_rc: int, restoration_ok: bool) -> None:
    _write_text(
        doc_path("CODEX_G0R4R_EXTERNAL_REJECTION_REMEDIATION_REPORT.md"),
        "\n".join(
            [
                ...
                "- Authorization basis: EXTERNAL_REVIEW_APPROVAL_G0R4R_REMEDIATION_RESUBMISSION_ONLY.md",
                "- Preserve G0R4 exact-byte detached-attestation package structure",
                "- Non-self-referential CODEX_G0R4R_COMMITTED_PAYLOAD_MANIFEST.json",
...
def write_g0r4r_template() -> None:
    _write_text(
        ROOT / "EXTERNAL_REVIEW_APPROVAL_G0R4R_TEMPLATE.md",
        "\n".join(
            [
                "# External Review Approval — G0R4R (Template)",
                "",
                f"Phase: {G0R4R_PHASE_ID}",
                "REVIEW_ZIP_SHA256: DETACHED_ATTESTATION_ONLY",
                "External sealed: NO",
            ]
        )
    ...
    _write_text(
        ...
        "\n".join(
            [
                ...
                "G1: NOT AUTHORIZED",
                "",
                "Review ZIP: codex_g0r4r_verbatim_external_review_chain_resubmission.zip",
                "",
                "Separately submit:",
...
def run_tests() -> Tuple[int, str]:
    ...
    _write_text(doc_path("CODEX_G0R4R_TEST_OUTPUT.txt"), log)
...
def stage_allowlist_and_baseline(*, skip: Optional[Set[str]] = None) -> Tuple[bool, List[str], str]:
    ...
    authorized = set(AUTHORIZED_G0R4R_COMMIT_PATHS) | set(baseline)
    ...
    for rel in list(AUTHORIZED_G0R4R_COMMIT_PATHS) + baseline:
...
def commit_g0r4r(include: List[str], head: str) -> Tuple[bool, str, List[str]]:
    manifest_rel = doc_path(PAYLOAD_MANIFEST_NAME).relative_to(ROOT).as_posix()
...
def worktree_clean_for_packaging() -> bool:
    allowed = {
        G0R4R_ZIP.name,
        G0R4R_ATTESTATION.name,
        G0R4R_VERIFY_REPORT.name,
        G0R4R_SHA.relative_to(ROOT).as_posix(),
        G0R4R_SHA.name,
    ...
    for line in _run_git("status", "--porcelain").splitlines():
        ...
        if path in allowed or path.endswith(G0R4R_ZIP.name):
            continue
        return False
    return True
...
def main() -> int:
    if _run_git("log", "-1", "--format=%s") == G0R4R_COMMIT_MSG:
        ...
        if missing:
            print(json.dumps({"g0r4r_status": "BLOCKED", "zip_missing": missing}, indent=2))
            return 1
        G0R4R_SHA.parent.mkdir(parents=True, exist_ok=True)
        G0R4R_SHA.write_text(f"{zip_digest}  {G0R4R_ZIP.name}\n", encoding="utf-8")
        ...
        print(json.dumps({"g0r4r_status": "PASS" if ok else "BLOCKED", **verification}, indent=2))
        return 0 if ok else 1

    start_head = _run_git("rev-parse", "HEAD")
    branch = _run_git("branch", "--show-current")
    discovery = discover_required_inputs()
    write_input_discovery_report(discovery=discovery, branch=branch, head=start_head)
            ...
            json.dumps(
                {
                    ...
                    "blocker": "REQUIRED_EXTERNAL_INPUT_FILE_NOT_FOUND",
                    "authorization_document_verified": False,
    ...
    atomic_write_json(doc_path("CODEX_G0R4R_EXTERNAL_INPUT_HASH_VERIFICATION.json"), bundle_payload)
    if not bundle_ok:
        print(
            json.dumps(
                {
    ...
    if branch != "remediation/g0r4r-verbatim-external-review-chain":
        print(
            json.dumps(
                {
                    "g0r4r_status": "BLOCKED",
    ...
    atomic_write_json(doc_path("CODEX_G0R4R_AUTHORIZATION_VERIFICATION.json"), approval_payload)
    if not approval_ok:
        print(
            json.dumps(
                {
                    "g0r4r_status": "BLOCKED",
                    "blocker": "EXTERNAL_REMEDIATION_APPROVAL_NOT_VERIFIED",
                    "authorization_document_verified": False,
                    **approval_payload,
                },
                indent=2,
    ...
    ok_apply, apply_msg = apply_verbatim_external_review_inputs()
    if not ok_apply:
        print(
            json.dumps(
                {
                    "g0r4r_status": "BLOCKED",
                    "blocker": "EXTERNAL_REVIEW_INPUTS_MISSING",
                    "detail": apply_msg,
                },
                indent=2,
            )
    ...
    verbatim_ok, verbatim_payload = verify_verbatim_external_review_inputs()
    atomic_write_json(
        doc_path("CODEX_G0R4R_EXTERNAL_REVIEW_INPUT_VERBATIM_VERIFICATION.json"),
        verbatim_payload,
    )
    if not verbatim_ok:
        print(
    ...
    atomic_write_json(doc_path("CODEX_G0R4R_PROTECTED_HASHES_BEFORE.json"), protected_hash_snapshot(v5r_paths))
    comparison, restoration_ok = build_comparison(include_set)
    atomic_write_json(
        doc_path("CODEX_G0R4R_V5R_BASELINE_COMPARISON.json"),
        {
    ...
    atomic_write_json(doc_path("CODEX_G0R4R_PROTECTED_HASHES_AFTER.json"), protected_hash_snapshot(v5r_paths))

    update_phase_catalog()
    update_review_registry()
    write_authorization_artifacts(ROOT)
    write_g0r4r_review_snapshot(ROOT)
    write_change_manifest(list(AUTHORIZED_G0R4R_COMMIT_PATHS))
    write_git_status(branch=branch, start_head=start_head)
    write_g0r4r_template()
    update_next_cursor_prompt()

    test_rc, _ = run_tests()
    write_report(test_rc=test_rc, restoration_ok=restoration_ok)
    if test_rc != 0 or not restoration_ok:
        print(json.dumps({"g0r4r_status": "BLOCKED", "blocker": "TESTS_OR_BASELINE"}, indent=2))
        return 1
    ...
    if not ok_drift:
        print(json.dumps({"g0r4r_status": "BLOCKED", "unexpected": sorted(unexpected)}, indent=2))
        return 1

    ok, final_commit, _ = commit_g0r4r(include, start_head)
    if not ok or final_commit == start_head:
        print(json.dumps({"g0r4r_status": "BLOCKED", "blocker": "COMMIT_FAILED"}, indent=2))
        return 1

    if not worktree_clean_for_packaging():
        print(json.dumps({"g0r4r_status": "BLOCKED", "blocker": "WORKTREE_NOT_CLEAN"}, indent=2))
        return 1
    ...
    zip_verbatim_ok, zip_verbatim_payload = verify_verbatim_external_review_inputs(zip_bytes)
    ...
    print(
        json.dumps(
            {
                "g0r4r_status": "PASS" if ok else "BLOCKED",
                ...
                "g0r4r_final_input_commit": final_commit,
