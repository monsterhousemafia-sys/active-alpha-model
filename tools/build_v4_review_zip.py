"""Build codex_v4_gui_review.zip with duplicate-path guard."""
...
ZIP_NAME = "codex_v4_gui_review.zip"

INCLUDE = [
    "EXTERNAL_REVIEW_APPROVAL_V4.md",
    "AGENTS.md",
    "VISION_PROGRESS.json",
    doc_rel("CODEX_V4_PREFLIGHT.md"),
    doc_rel("CODEX_V4_GIT_STATUS.txt"),
    doc_rel("CODEX_V4_GUI_REPORT.md"),
    doc_rel("CODEX_V4_TEST_OUTPUT.txt"),
    doc_rel("CODEX_V4_PROTECTED_HASHES_BEFORE.json"),
    doc_rel("CODEX_V4_PROTECTED_HASHES_AFTER.json"),
    ...
    "tests/test_v3_review_zip_packaging.py",
    "V4-BACKUP_MANIFEST.json",
    ".cursor/hooks.json",
]
