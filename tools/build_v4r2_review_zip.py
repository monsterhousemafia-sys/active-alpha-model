"""Build codex_v4r2_final_gui_gate_review.zip with duplicate-path and hash guards."""
...
ZIP_NAME = "codex_v4r2_final_gui_gate_review.zip"

INCLUDE = [
    "EXTERNAL_REVIEW_APPROVAL_V4R2.md",
    "AGENTS.md",
    "VISION_PROGRESS.json",
    doc_rel("CODEX_V4R2_PREFLIGHT.md"),
    doc_rel("CODEX_V4R2_GIT_STATUS.txt"),
    doc_rel("CODEX_V4R2_FINAL_GUI_GATE_REPORT.md"),
    doc_rel("CODEX_V4R2_TEST_OUTPUT.txt"),
    doc_rel("CODEX_V4R2_PROTECTED_HASHES_BEFORE.json"),
    doc_rel("CODEX_V4R2_PROTECTED_HASHES_AFTER.json"),
...
def validate_protected_hashes(root: Path) -> Tuple[bool, List[str]]:
    errors: List[str] = []
    before_path = root / doc_rel("CODEX_V4R2_PROTECTED_HASHES_BEFORE.json")
    after_path = root / doc_rel("CODEX_V4R2_PROTECTED_HASHES_AFTER.json")
